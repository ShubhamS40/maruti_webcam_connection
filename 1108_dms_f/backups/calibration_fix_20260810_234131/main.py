    ...
    while True:
        ...
        if not active:
            ...
            if not face_lost:
                ...
                yawn_alert = None
                if yawn["is_yawning"] or yawn.get("yawn_detected_alert", False):
                    if yawn["big_yawning"]:
            ...
            debug = {
                ...
                "yawn_start_thr": yawn.get("yawn_start_threshold", 0.58),
                "yawn_end_thr": yawn.get("yawn_end_threshold", 0.48),
                "yawn_candidate_frames": yawn.get("open_frames", 0),
                "yawn_required_frames": yawn.get("required_frames", 0),
                "yawn_active": yawn.get("is_yawning", False),
